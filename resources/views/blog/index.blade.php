        ...
        <div class="blog">
            ...
            <div class="row my-5">
                <div class="col-md-6 p-md-5 pt-3 pt-md-0 order-last">
                    ...
                    <a href="{{ route('blog.show', $blog->id) }}" class="btn btn-outline-dark mt-2 w-50 mt-5">Read More</a>
                </div>
                <div class="col-md-6 order-first order-md-last d-flex justify-content-center">
                    <img src="{{Storage::url($blog->img)}}" alt="Coconut" width="500px">
                </div>
            </div>
            @else
            <div class="row my-5">
        ...
        <div class="row my-5">
            <div class="col-md-6 p-md-5 pt-3 pt-md-0 order-last">
                ...
                <p>Can you believe we’re here? Another year is wrapping up and we’re feeling celebratory, wanting to share our list for the best products of 2025.
                    There are so many ways to categorize what is already a collection of our favorite brands , but ultimately we decided that by focusing on HOW CLEAN THE INGREDIENTS ARE, and HOW EFFECTIVE THE FORMULAS, you’ll be able to find something streamlined for glowing skin success.</p>
                <div class="tags pt-4">
                    <span class="badge bg-blog">#GreatGift</span>

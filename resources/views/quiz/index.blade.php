<x-layout title="Skin Quiz - Bloom Beauty">
    <div class="container">
        <h1 class="mb-4">Discover Your Skin Type</h1>

        <!-- Start Button -->
        <button type="button" class="btn btn-primary mb-4" id="startButton" onclick="startQuiz()">Start</button>
        ...
        <div id="personalInfoForm" style="display:none;">
            ...
            <form id="personalInfo">
                ...
                <button type="button" class="btn btn-primary" onclick="showQuizForm()">Next</button>
            </form>
        </div>

        <!-- Skin Quiz Form -->
        <div id="skinQuizForm" style="display:none;">
            <h3>Answer the following questions about your skin</h3>
            <form id="quizForm">
                @csrf
                <div class="mb-3">
                    <label class="form-label">How would you describe the texture of your skin?</label>
                ...
                <div class="mb-3">
                    <label class="form-label">What is the size of the pores on your face?</label>
                ...
                <div class="mb-3">
                    <label class="form-label">Does your skin tend to get oily during the day?</label>
                ...
                <div class="mb-3">
                    <label class="form-label">Do you suffer from redness or skin irritations?</label>
                ...
                <div class="mb-3">
                    <label class="form-label">How does your skin behave after applying skincare products?</label>
    ...
    <script>
        ...
        function createResultCard(skinType) {
            ...
            cardTitle.innerText = "Your Skin Type";

<x-layout title="Skin Quiz - Bloom Beauty">
    <div class="bg-register min-vh-100 ">
        <div class="container pt-5 d-flex flex-column justify-content-start">
            <div class="row">
                <div class="col-12">
                    <x-quiz />
                    <!-- Personal Information Form -->
                    <div class="quiz-section p-5 shadow mb-5" id="personalInfoForm" style="display:none;">
    ...
    <script>
        ...
        function createResultCard(skinType) {
            ...
            cardBody.classList.add('card-custom', 'quiz-section', 'p-5', 'text-center');
